/*  Downloaded from http://grepcode.com/file/repo1.maven.org/maven2/nz.ac.waikato.cms.weka/CABSMOTEsI/1.0.1/weka/filters/supervised/instance/CABSMOTEsI.java 
...
/**
 <!-- globalinfo-start -->
 * 01 Resamples a dataset by applying the Synthetic Minority Oversampling TEchnique (CABSMOTEsI). The original dataset must fit entirely in memory. The amount of CABSMOTEsI and number of nearest neighbors may be specified. For more information, see <br/>
 * <br/>
 ...
 * 
 * <pre> -P &lt;percentage&gt;
 *  Specifies percentage of CABSMOTEsI instances to create.
 *  (default 100.0)
 * </pre>
 * 
 ...
 * 
 * <pre> -C &lt;value-index&gt;
 *  Specifies the index of the nominal class value to CABSMOTEsI
 ...
 */
public class CABSMOTEsI extends Filter  implements SupervisedFilter, OptionHandler, TechnicalInformationHandler {
  ...
  /** the percentage of CABSMOTEsI instances to create. */
  ...
  public String globalInfo() {
    return "Resamples a dataset by applying the Synthetic Minority Oversampling TEchnique (CABSMOTEsI)." +
    " The original dataset must fit entirely in memory." +
    " The amount of CABSMOTEsI and number of nearest neighbors may be specified." +
...
/*    result.add("-D2C");
  ...
  public String percentageTipText() {
    return "The percentage of CABSMOTEsI instances to create.";
  }

  /**
   * Sets the percentage of CABSMOTEsI instances to create.
   * 
  ...
  /**
   * Gets the percentage of CABSMOTEsI instances to create.
   * 
   * @return 		the percentage of CABSMOTEsI instances to create
   */
  ...
  public String classValueTipText() {
    return "The index of the class value to which CABSMOTEsI should be applied. " +
    "Use a value of 0 to auto-detect the non-empty minority class.";
  }

  /**
   * Sets the index of the class value to which CABSMOTEsI should be applied.
   * 
  ...
  /**
   * Gets the index of the class value to which CABSMOTEsI should be applied.
   * 
   * @return 		the index of the clas value to which CABSMOTEsI should be applied
   */
...
/*  	    public String DangerToClassTipText() {
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (!m_FirstBatchDone) {
      // Do CABSMOTEsI, and clear the input instances.
      doCABSMOTEsI();
	  	 // JOptionPane.showMessageDialog(null,"CABSMOTEsI 19-09-2018 ");
  ...
  /**
   * The procedure implementing the CABSMOTEsI algorithm. The output
   * instances are pushed onto the output queue for collection.
   * 
   * @throws Exception 	if provided options cannot be executed 
   * 			on input instances
   */
  protected void doCABSMOTEsI() throws Exception 
  {
    int minIndex = 0;
    ...
    // the main loop to handle computing nearest neighbors and generating CABSMOTEsI
...
Instance[] nnArray = new Instance[knearestNeighbors];	
	...
	//	if (a != permaxValueindex && perdatatomax[a] >= 0.30 )
		{
		...
		//		JOptionPane.showMessageDialog(null," If statement is true"+perdatatomax[a]);
			...
			//	for (int b= dataset[a].numInstances();b< dataset[permaxValueindex].numInstances();b++)
						...
						while(n > dataset[a].numInstances() || extraIndexSet.remove(i)) 
						{
