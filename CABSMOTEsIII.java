/*  Downloaded from http://grepcode.com/file/repo1.maven.org/maven2/nz.ac.waikato.cms.weka/CABSMOTEsIII/1.0.1/weka/filters/supervised/instance/CABSMOTEsIII.java 
...
/**
 <!-- globalinfo-start -->
 * 01 Resamples a dataset by applying the Synthetic Minority Oversampling TEchnique (CABSMOTEsIII). The original dataset must fit entirely in memory. The amount of CABSMOTEsIII and number of nearest neighbors may be specified. For more information, see <br/>
 * <br/>
 ...
 * 
 * <pre> -P &lt;percentage&gt;
 *  Specifies percentage of CABSMOTEsIII instances to create.
 *  (default 100.0)
 * </pre>
 * 
 ...
 * 
 * <pre> -C &lt;value-index&gt;
 *  Specifies the index of the nominal class value to CABSMOTEsIII
 ...
 */
public class CABSMOTEsIII extends Filter  implements SupervisedFilter, OptionHandler, TechnicalInformationHandler {
...
//  public int DangerToClass= 0;
  ...
  /** the percentage of CABSMOTEsIII instances to create. */
  ...
  public String globalInfo() {
    return "Resamples a dataset by applying the Synthetic Minority Oversampling TEchnique (CABSMOTEsIII)." +
    " The original dataset must fit entirely in memory." +
    " The amount of CABSMOTEsIII and number of nearest neighbors may be specified." +
...
/*    result.add("-D2C");
  ...
  public String percentageTipText() {
    return "The percentage of CABSMOTEsIII instances to create. 1.5 adds 50%, 2 adds 100%, 3 adds 200%, 4 adds 300%,5 adds 400%";
  }

  /**
   * Sets the percentage of CABSMOTEsIII instances to create.
   * 
  ...
  /**
   * Gets the percentage of CABSMOTEsIII instances to create.
   * 
   * @return 		the percentage of CABSMOTEsIII instances to create
   */
  ...
  public String classValueTipText() {
    return "The index of the class value to which CABSMOTEsIII should be applied. " +
    "Use a value of 0 to auto-detect the non-empty minority class.";
  }

  /**
   * Sets the index of the class value to which CABSMOTEsIII should be applied.
   * 
  ...
  /**
   * Gets the index of the class value to which CABSMOTEsIII should be applied.
   * 
   * @return 		the index of the clas value to which CABSMOTEsIII should be applied
   */
...
/*  	    public String DangerToClassTipText() {
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (!m_FirstBatchDone) {
      // Do CABSMOTEsIII, and clear the input instances.
      doCABSMOTEsIII();
	  	 // JOptionPane.showMessageDialog(null,"CABSMOTEsIII 19-09-2018 ");
  ...
  /**
   * The procedure implementing the CABSMOTEsIII algorithm. The output
   * instances are pushed onto the output queue for collection.
   * 
   * @throws Exception 	if provided options cannot be executed 
   * 			on input instances
   */
  protected void doCABSMOTEsIII() throws Exception 
  {
    int minIndex = 0;
    ...
    // the main loop to handle computing nearest neighbors and generating CABSMOTEsIII
...
Instance[] nnArray = new Instance[knearestNeighbors];	
  ...
  public static void main(String[] args) {
    runFilter(new CABSMOTEsIII(), args);
  }
}
