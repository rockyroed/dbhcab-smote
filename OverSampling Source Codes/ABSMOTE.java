/*  Downloaded from http://grepcode.com/file/repo1.maven.org/maven2/nz.ac.waikato.cms.weka/ABSMOTE/1.0.1/weka/filters/supervised/instance/ABSMOTE.java 
...
/**
 <!-- globalinfo-start -->
 * 01 Resamples a dataset by applying the Affinitive Borderline Synthetic Minority Oversampling Technique (ABSMOTE). The original dataset must fit entirely in memory. The amount of ABSMOTE and number of nearest neighbors may be specified. For more information, see <br/>
 * <br/>
 ...
 * 
 * <pre> -P &lt;percentage&gt;
 *  Specifies percentage of ABSMOTE instances to create.
 *  (default 100.0)
 * </pre>
 * 
 ...
 * 
 * <pre> -C &lt;value-index&gt;
 *  Specifies the index of the nominal class value to ABSMOTE
 ...
 */
public class ABSMOTE extends Filter  implements SupervisedFilter, OptionHandler, TechnicalInformationHandler {
  ...
  /** the percentage of ABSMOTE instances to create. */
  ...
  public String globalInfo() {
    return "Resamples a dataset by applying the Affinitive Borderline Synthetic Minority Oversampling TEchnique (ABSMOTE)." +
    " The original dataset must fit entirely in memory." +
    " The amount of ABSMOTE and number of nearest neighbors may be specified." +
  ...
  public String percentageTipText() {
    return "The percentage of ABSMOTE instances to create.";
  }

  /**
   * Sets the percentage of ABSMOTE instances to create.
   * 
  ...
  /**
   * Gets the percentage of ABSMOTE instances to create.
   * 
   * @return 		the percentage of ABSMOTE instances to create
   */
  ...
  public String classValueTipText() {
    return "The index of the class value to which ABSMOTE should be applied. " +
    "Use a value of 0 to auto-detect the non-empty minority class.";
  }

  /**
   * Sets the index of the class value to which ABSMOTE should be applied.
   * 
  ...
  /**
   * Gets the index of the class value to which ABSMOTE should be applied.
   * 
   * @return 		the index of the clas value to which ABSMOTE should be applied
   */
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (!m_FirstBatchDone) {
      // Do ABSMOTE, and clear the input instances.
      doABSMOTE();
	  	 // JOptionPane.showMessageDialog(null,"ABSMOTE 19-09-2018 ");
    }
    flushInput();
  ...
  /**
   * The procedure implementing the ABSMOTE algorithm. The output
   * instances are pushed onto the output queue for collection.
   * 
   * @throws Exception 	if provided options cannot be executed 
   * 			on input instances
   */
  protected void doABSMOTE() throws Exception 
  {
    int minIndex = 0;
    ...
    // the main loop to handle computing nearest neighbors and generating ABSMOTE
