/*  Downloaded from http://grepcode.com/file/repo1.maven.org/maven2/nz.ac.waikato.cms.weka/BorderlineExtractor/1.0.1/weka/filters/supervised/instance/BorderlineExtractor.java 
...
/**
 <!-- globalinfo-start -->
 * 01 Resamples a dataset by applying the Synthetic Minority Oversampling TEchnique (BorderlineExtractor). The original dataset must fit entirely in memory. The amount of BorderlineExtractor and number of nearest neighbors may be specified. For more information, see <br/>
 * <br/>
 ...
 * 
 * <pre> -P &lt;percentage&gt;
 *  Specifies percentage of BorderlineExtractor instances to create.
 *  (default 100.0)
 * </pre>
 * 
 ...
 * 
 * <pre> -C &lt;value-index&gt;
 *  Specifies the index of the nominal class value to BorderlineExtractor
 ...
 */
public class BorderlineExtractor extends Filter  implements SupervisedFilter, OptionHandler, TechnicalInformationHandler {
 ...
 // public int DangerToClass= 0;
  ...
  /** the percentage of BorderlineExtractor instances to create. */
  ...
  public String globalInfo() {
    return "Resamples a dataset by applying the Hybrid Clustered Affinitive Borderline Synthetic Minority Oversampling TEchnique (BorderlineExtractor)."+
    ...
    " The amount of BorderlineExtractor and number of nearest neighbors may be specified." +
...
//	result.add("" + getDangerToClass());
  ...
  public String percentageTipText() {
    return "The percentage of BorderlineExtractor instances to create. 1.5 adds 50%, 2 adds 100%, 3 adds 200%, 4 adds 300%,5 adds 400%";
  }

  /**
   * Sets the percentage of BorderlineExtractor instances to create.
   * 
  ...
  /**
   * Gets the percentage of BorderlineExtractor instances to create.
   * 
   * @return 		the percentage of BorderlineExtractor instances to create
   */
  ...
  public String classValueTipText() {
    return "The index of the class value to which BorderlineExtractor should be applied. " +
    "Use a value of 0 to auto-detect the non-empty Minority class.";
  }

  /**
   * Sets the index of the class value to which BorderlineExtractor should be applied.
   * 
  ...
  /**
   * Gets the index of the class value to which BorderlineExtractor should be applied.
   * 
   * @return 		the index of the clas value to which BorderlineExtractor should be applied
   */
...
/*  	    public String DangerToClassTipText() {
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (!m_FirstBatchDone) {
      // Do BorderlineExtractor, and clear the input instances.
      doBorderlineExtractor();
	  	 // JOptionPane.showMessageDialog(null,"BorderlineExtractor 19-09-2018 ");
  ...
  /**
   * The procedure implementing the BorderlineExtractor algorithm. The output
   * instances are pushed onto the output queue for collection.
   * 
   * @throws Exception 	if provided options cannot be executed 
   * 			on input instances
   */
  protected void doBorderlineExtractor() throws Exception 
  {
	int NumGen=0;
    int minIndex = 0;
...
//	sample2.add(instance);  // Minority without mindanger
    ...
    // the main loop to handle computing nearest neighbors and generating BorderlineExtractor
...
//	remove.setInvertSelection(false);
	...
	BufferedWriter writer = new BufferedWriter(new FileWriter("./data/BorderlineExtractor.arff"));
	writer.write(mindanger.toString());
	writer.flush();
	writer.close();
	JOptionPane.showMessageDialog(null,"a file is exported to into the Data folder, Oversampled: "+ NumGen );
  ...
  public static void main(String[] args) {
    runFilter(new BorderlineExtractor(), args);
  }
}
